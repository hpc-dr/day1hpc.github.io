...
# Taxonomies
categories: []
tags: [ "API Gateway",  "Lambda",  "Simulation",  "HPC",  "Serverless",  "hpcblog", ]
...
<a href="https://aws.amazon.com/blogs/hpc/high-burst-cpu-compute-for-monte-carlo-simulations-on-aws/" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-top: 8px;">Read the Post on the AWS Blog Channel</a>