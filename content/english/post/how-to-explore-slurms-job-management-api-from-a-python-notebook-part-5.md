...
tags: [ "API",  "CPUs",  "Covid-19",  "DCV",  "EC2",  "GPUs",  "HPC",  "High Performance Computing",  "Lustre",  "ParallelCluster",  "SGE",  "Schedulers",  "Slurm",  "Storage",  "job control",  "virtualization",  "vizualization",  "techshorts", ]
