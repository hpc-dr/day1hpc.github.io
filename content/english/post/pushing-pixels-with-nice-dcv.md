...
# Taxonomies
categories: [ "NICE DCV", ]
tags: [ "HPC",  "Media",  "NICE DCV",  "hpcblog", ]
...
<a href="https://aws.amazon.com/blogs/hpc/pushing-pixels-with-nice-dcv/" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-top: 8px;">Read the Post on the AWS Blog Channel</a>