...
tags: [ "Batch",  "Modeling",  "HPC",  "AI/ML",  "Media",  "hpcblog", ]
...
<a href="https://aws.amazon.com/blogs/hpc/bayesian-ml-models-at-scale-with-aws-batch/" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-top: 8px;">Read the Post on the AWS Blog Channel</a>