...
tags: [ "ParallelCluster",  "Public Sector",  "FSx for Lustre",  "Simulation",  "Research",  "Modeling",  "HPC",  "Sustainability",  "Climate/Environment/Weather",  "Media",  "hpcblog", ]
...
<a href="https://aws.amazon.com/blogs/hpc/supporting-climate-model-simulations-to-accelerate-climate-science/" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-top: 8px;">Read the Post on the AWS Blog Channel</a>