...
tags: [ "ParallelCluster",  "Systems Manager",  "API Gateway",  "Lambda",  "HPC",  "Serverless Application Model",  "hpcblog", ]
...
<a href="https://aws.amazon.com/blogs/hpc/how-to-manage-hpc-jobs-using-a-serverless-api/" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-top: 8px;">Read the Post on the AWS Blog Channel</a>